...
class Redis_Hash_Dictionary( object ):
   ...
   def hset( self, field, data ):
      ...
      if self.redis_handle.hget(self.key,field)== data: # donot propagte identical values
         return
...
if __name__== "__main__":
       ...
       stream_writer = Stream_Writer( redis_handle, {"depth":64}, key ="__STREAM__TEST__",cloud_handler = None )
       stream_writer.push("*",dict_table_1)
       stream_writer.delete_all()
       for i in range(0,16):
          stream_writer.push("*",dict_table_1)
